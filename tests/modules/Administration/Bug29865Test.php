...
class Bug29865Test extends Sugar_PHPUnit_Framework_TestCase {

	function setUp() 
	{
		$_SESSION['general_error'] = "Hello World";
	}
	...
	function testGeneralError() {	
		...
		$this->assertNull($_SESSION['general_error'],'Session var general_error was not unset properly');
